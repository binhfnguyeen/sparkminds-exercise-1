        ...
        httpSecurity
                ...
                .authorizeHttpRequests(request
                    -> request.requestMatchers(HttpMethod.OPTIONS, "/api/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/change-password").hasRole("USER")
                        .requestMatchers(HttpMethod.POST, "/api/change-phone").hasRole("USER")
                        .requestMatchers(HttpMethod.POST, "/api/send-otp-change-mail").hasRole("USER")
                        .requestMatchers(HttpMethod.POST, "/api/change-mail").hasRole("USER")
                        .requestMatchers(HttpMethod.POST, "/api/mfa/setup").hasRole("USER")
                        .requestMatchers(HttpMethod.POST, "/api/mfa/enable").hasRole("USER")
